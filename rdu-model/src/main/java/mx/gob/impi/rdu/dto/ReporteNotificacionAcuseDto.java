 ...
 * @author
 */
public class ReporteNotificacionAcuseDto {
    ...
    public ReporteNotificacionAcuseDto() {
        super();
    }

    public ReporteNotificacionAcuseDto(Notificacion not, FirmaDto firm,String ruta ) {
        this.firma = firm;
