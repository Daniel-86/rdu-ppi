 ...
 * @author marisol
 */
public class ReporteRenovacionDto {
    ...
    public ReporteRenovacionDto(TramitePromocionMarca tramitePromocion, String rutaFirmaImpi, List<CatSubtiposolicitud> listaSubTiposSolicitud, List<EntidadFederativa> entidadesFederativas) { //,
